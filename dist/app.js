...
const site_config_routes_1 = require("./modules/site-config/site-config.routes");
const landing_image_routes_1 = require("./modules/landing-image/landing-image.routes");
...
app.use('/api/v1/site-config', site_config_routes_1.siteConfigRouter);
